...
## How to use this framework for a designed existing model?
...
Blocks with memories must be identified and marked with their states. The states start from number zero (`x0`) however the order of assigning members of `dx/dt` is not important:
