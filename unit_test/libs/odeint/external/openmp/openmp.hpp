...
#include "odeint/external/openmp/openmp_range_algebra.hpp"

// level 2: split range state
#include "odeint/external/openmp/openmp_state.hpp"

// level 3: process a random access container of sub-states in parallel
#include "odeint/external/openmp/openmp_nested_algebra.hpp"
