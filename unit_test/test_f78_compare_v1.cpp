...
#include "libs/solver-v1/solver_f78.hpp"
...
public:
	...
	void integrate_adaptive_current()
	{
		...
		ode::Solver<ode::Steppers::RKF78,CSystem> solver_current(std::ref(*this));
	...
	{
		state_type X=start_state;
		odev1::Solver<odev1::Steppers::RKF78,CSystem> solver_v1(std::ref(*this));
...
int main()
{
	const std::string title="comparison between current and v1.0 results (F78)";
